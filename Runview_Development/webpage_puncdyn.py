...
def webpage_data(datadir, metadata, parfile, locate_merger):
...
<h1 style=\"text-align:center; font-size:300% \n \"> {} </h1>""".format('BBH')
	...
	html_txt = html_txt + """
\n <h2 style=\"text-align:left;font-size:150%;font-family:verdana\"> Metadata </a></h2>
\n <ul>
...
\n <h2 style=\"text-align:left;font-size:150%;font-family:verdana\"><a href=\"Trajectory.html\">Trajectory Plots</a> </h2>
\n 
\n <p> <a href=\"figures/Trajectory_separation.png\"><img src=\"figures/Trajectory_separation.png\" alt=\"HTML/Trajectory_separation\" width=\"700\" height=\"600\" hspace=20></a>
\n  <a href=\"figures/Trajectory_phase.png\"><img src=\"figures/Trajectory_phase.png\" alt=\"HTML/Trajectory_phase\" width=\"700\" height=\"600\" hspace=20></a></p>
\n 
...
\n  <a href=\"figures/ArealRadius.png\"><img src=\"figures/ArealRadius.png\" alt=\"ArealRadius.png\" width=\"700\" height=\"600\"></a></p>"""
	...
	prop_dist = os.path.join(datadir, '../figures/ProperDistance.png')
	if os.path.exists(prop_dist):
	    html_txt = html_txt + """
\n 
\n <h2 style=\"text-align:left;font-size:150%;font-family:verdana\"> Trumpet Plots and Proper Distance </a></h2>
...
\n  <a href=\"figures/ProperDistance.png\"><img src=\"figures/ProperDistance.png\" alt=\"ProperDistance.png\" width=\"700\" height=\"600\" hspace=20></a></p>"""
	    ...
	    html_txt = html_txt + """
\n 
\n <h2 style=\"text-align:left;font-size:150%;font-family:verdana\"> Trumpet Plots </a></h2>
\n <p> <a href=\"figures/Trumpets.png\"><img src=\"figures/Trumpets.png\" alt=\"Trumpets.png\" width=\"700\" height=\"600\"></a></p>"""


	if os.path.exists(os.path.join(datadir, "../figures/Runstats.png")):
	    html_txt = html_txt + """
\n 
...
\n""" 
	...
	if os.path.exists(os.path.join(datadir, "../figures/Spin_Magnitude.png")):
	    html_txt = html_txt + """
\n 
...
def webpage_pd(wfdir, outdir,locate_merger):
	...
	webdata = webpage_data(datadir, meta_data, parfile, locate_merger=False)
	filename.write(webdata)
	filename.close()

	filename = open(os.path.join(datadir+'/..','Trajectory.html'),'w+')

	webdata_traj = webpage_trajectory()
	filename.write(webdata_traj)
	filename.close()
