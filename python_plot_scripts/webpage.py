...
\n <li> Spin of BH1 = {}</li>
\n <li> Spin of BH2 = {}</li>	""".format(metadata['alternative-names'], metadata['simulation-type'], metadata['mass-ratio'], metadata['init_sep'], metadata['spin1'], metadata['spin2'])



	html_txt = html_txt + """

\n <h2><a href=\"HTML/Trajectory.html\">Trajectory Plots</a> </h2>
\n 
\n <p> <a href=\"figures/Trajectory_xy.png\"><img src=\"figures/Trajectory_xy.png\" alt=\"HTML/Trajectory_xy\" width=\"500\" height=\"400\" hspace=20></a>
...
\n  <a href=\"figures/Momentum_mag.png\"><img src=\"figures/Momentum_mag.png\" alt=\"Pmag.png\" width=\"500\" height=\"400\"></a></p>
\n 
...
\n <ul>
\n <li><a href=\"data/{}.par\">Parameter File</a> </li>
...
\n </html>
\n 
	""".format(metadata['alternative-names'])
	return html_txt
...
def webpage(wfdir, outdir):
	...
	meta_data = metadata(wfdir, outdir)
	webdata = webpage_data(meta_data)
